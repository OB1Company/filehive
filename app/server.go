...
func (s *FileHiveServer) newV1Router() *mux.Router {
	...
	subRouter.HandleFunc("/delist", s.handlePOSTAdminDelist).Methods("POST")
	subRouter.HandleFunc("/relist", s.handlePOSTAdminRelist).Methods("POST")
	...
	subRouter.HandleFunc("/admin/sales", s.handleGETAdminSales).Methods("GET")
	subRouter.HandleFunc("/admin/datasets", s.handleGETAdminDatasets).Methods("GET")
